...
const Header = ({ isDarkMode, changeMode, scaleColor, changeScaleColor }) => {
  return (
    <div>
      ...
      <div
        className={`${scaleColor === 1 ? "bg-[#546CA6] " : scaleColor === 2 ? "bg-[#FDA92D]" : scaleColor === 3 ? "bg-[#00A76F]" : "bg-[#546CA6]"} py-2`}
      >
